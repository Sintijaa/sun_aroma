...
function Auskari() {
    ...
    const products = [
        { id: 5, name: 'Epoksīda sveķu auskari ar sudraba folliju',  alt:'auskari1', price: '8.00', image: auskari1, description: 'Eleganti auskari ar sudraba folliju' },
        { id: 6, name: 'Auskari ar kaltētiem ziediem', price: '10.00', alt:'auskari2', image: auskari2, description: 'Auskari ar skaistiem kaltētiem ziediem' },
        { id: 7, name: 'Auskari kas atgādinās par vasaru pat ziemā', alt:'auskari3', price: '16.99', image: auskari3, description: 'Gaiši un krāsaini auskari' },
        { id: 8, name: 'Auskari spilgtiem cilvēkiem', price: '18.99', alt:'auskari4', image: auskari4, description: 'Spilgti auskari pašizpausmei' }
    ];
