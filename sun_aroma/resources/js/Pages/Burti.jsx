...
function Burti() {
    ...
    const addToCart = async (item) => {
        ...
        const productData = {
			...
			selected_material: selectedMaterials[item.id] || item.krasa?.[0] || '',
    ...
    const products = [
        {
            ...
            price: "5.00",
            materials: ["Rozā", "Violets", "Zils", "Balts", "Dzeltens"]
        },
        {
            id: 13,
            ...
            price: "5.00",
            materials: ["Zaļš", "Zils", "Melns", "Bordo"]
        },
        {
            id: 14,
            ...
            price: "5.00",
            materials: ["Sarkani spīdumi", "Balti spīdumi", "Zili spīdumi", "Rozā spīdumi"]
        }
    ];
